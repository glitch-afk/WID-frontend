...
const CustomWalletConnect = (props) => {
  return (
              ...
              if (chain.unsupported) {
                return (
                  <button
                    ...
                    type="button"
                    className="rounded-full bg-red-400 px-6 py-2 text-sm font-medium text-white"
                  >
                    Wrong network
                  </button>
                )
              ...
              return (
                <div style={{ display: 'flex', gap: 12 }}>
                  <button
                    ...
                    type="button"
                    className="rounded-full bg-gradient-to-r from-wid-indigo to-wid-purple px-6 py-2 text-sm font-medium text-white"
                  >
                    {chain.hasIcon && (
                      <div
                        style={{
                        ...
                        className="mr-4 -ml-2 h-fit w-full rounded-full"
                      >
                        {chain.iconUrl && (
                          <img
